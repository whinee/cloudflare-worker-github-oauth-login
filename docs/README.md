...
Github: [github.com/whinee/gh-oa-cf-wk](https://github.com/whinee/gh-oa-cf-wk)

REST API: [gh.wya.workers.dev](https://gh.wya.workers.dev)

## **Important**

This project is a work in progress, use at your own risk.

The previous commits where the fork is still licensed under the ISC license shall now be licensed under the MIT license. For more details, go to [docs/NOTICE.md](NOTICE.md).
...
- You should be greeted with a form as seen below:

    <img src="assets/images/gh/new-app.png" style="max-height: 25%">
...
- In your preferred terminal, run the following command:
    ...
    ```bash
    git clone https://github.com/whinee/gh-oa-cf-wk.git
    cd kv
...
- Focus on the browser by hovering the cursor over the said window and clicking on it. A prompt like the following should appear:
    ...
    <img src="assets/images/cf/con-app.png" style="max-height: 25%">
    ...
    <img src="assets/images/cf/wc.png">
...
- Go at [Cloudflare Workers Dashboard](https://dash.cloudflare.com), and click the dropdown button next to the "`Workers`" button in the sidebar as shown below:
    ...
    <img src="assets/images/cf/dash-sb.png">
